                    ...
                    <div id="tugas-content">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<span><img src="Assets/date.png" alt="Calendar Icon" class="icon"> Deadline: ' . htmlspecialchars($row['tanggal_deadline']) . '</span>';
        ...
        document.getElementById('upload-form').onsubmit = function(e) {
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
                    ...
                    closeUploadPopup(); // Menutup popup setelah sukses
                } else {
