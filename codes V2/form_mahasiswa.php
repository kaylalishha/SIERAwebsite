...
?>
        <h2>Isi Data <span class="highlight">Mahasiswa</span></h2>
        <form id="mhs-form" method="post" action="save_mahasiswa.php">
            ...
            <button class="mhs-btn" type="submit">Simpan Data</button>
        </form>
    </div>
